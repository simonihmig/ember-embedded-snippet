...
class ProcessHtmlPlugin extends Plugin {
  ...
  _processHtml() {
    ...
    this.styles = document.querySelectorAll('style:not([data-embedded-ignore])');
    ...
    this.links.forEach((ref) => ref.remove());
